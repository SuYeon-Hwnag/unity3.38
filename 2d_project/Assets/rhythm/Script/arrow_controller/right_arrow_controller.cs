...
public class right_arrow_controller : MonoBehaviour
{
    GameObject Rbutton;
    ...
    void Update()
    {
        ...
        // 충돌 판정
        if (this.transform.position.y > -5.0f && this.transform.position.y < -3.75f && GameObject.Find("GameDirector").GetComponent<button_controller>().isrbutton)
        {
            // 점수 올라감
